...
const AllClientCard = ({ clientData }) => {
              ...
              <Card style={{background: '#ffffff', height:200, marginBottom: 20}}>
                ...
                <div className="grid formgrid text-center">
                    <div className="field col-12 md:col-4">
                        ...
                        <Knob value={clientData && selectValue == 1 ? clientData[0].totclient : clientData && selectValue ==2 ? clientData[1].totclient: clientData && selectValue == 3 ? clientData[2].totclient : clientData && selectValue == 4 ? clientData[3].totclient: '0'  } strokeWidth={5} 
