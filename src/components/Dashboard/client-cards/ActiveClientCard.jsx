...
const ActiveClientCard = ({ clientData }) => {
              ...
              <Card style={{background: '#ffffff', height:200, marginBottom: 20}}>
                ...
                <div className="grid formgrid text-center">
                    <div className="field col-12 md:col-4">
                        ...
                        <Knob value={clientData && selectValue == 1 ? clientData[0].actclient : clientData && selectValue ==2 ? clientData[1].actclient: clientData && selectValue == 3 ? clientData[2].actclient : clientData && selectValue == 4 ? clientData[3].actclient: '0'  } strokeWidth={5} 
